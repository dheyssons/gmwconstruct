        ...
        <section>
            <div className="container mx-auto flex flex-col items-center gap-y-10">~
                <div className="overflow-hidden">
                    <motion.h1 variants={upward} initial="variantInit" whileInView="variantAnim" viewport={{once: true}} transition={transition1} className="h1 mt-40">Notre travail</motion.h1>
                </div>
                    ...
                    <div className="flex flex-col gap-y-24">
                        ...
                        <motion.div variants={upward} initial="variantInit" whileInView="variantAnim" viewport={{once: true}} transition={transition1_s} className="grid-images">
                            ...
                            <motion.div variants={item} className="wrapper-image">
                                ...
                                <motion.div variants={item} className="wrapper-image w-[20rem] bg-[#252b37]">
                                </motion.div>
                        </motion.div>
