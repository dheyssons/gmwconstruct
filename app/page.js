      ...
      <div className='flex flex-col gap-y-12 lg:gap-y-32 py-4 lg:py-8'>
        ...
        {/* CONTACT US */}
         <div id='contactus' className='container mx-auto flex flex-col items-center gap-y-8'>
          <div className=''>
            <motion.h3 variants={upward} initial="variantInit" whileInView="variantAnim" viewport={{once: true}} transition={transition1} className='h3 text-center lg:mt-40'>Contactez-nous sans engagement</motion.h3>
          </div>
