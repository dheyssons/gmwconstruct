...
import { transition1_d } from '@/public/transitions/transition1_d';
    ...
    <section className="section flex flex-col gap-y-10 lg:gap-y-20">
      ...
      <div className='flex flex-col gap-y-20 py-8'>
        ...
        <div id='services' className='container mx-auto flex flex-col items-center gap-y-20'>
          ...
          <div className='wrapper-services'>
            ...
            <div className='card-services'>
                <img alt='' src="images/services/bardage.webp"></img>
                {/* text */}
            ...
            <div className='card-services'>
              ...
              <img alt='' src='images/services/charpenter.webp'></img>

            </div>
            {/* Couverture */}
            <div className='card-services'>
              <img alt='' src='images/services/couverture.png'></img>
              {/* text */}
              <div className='flex flex-col gap-y-8 justify-around'>
                {/* title */}
                <div>
            ...
            <div className='card-services'>
              ...
              <img alt='' src='images/services/plateforme.webp'></img>

            </div>
            {/* renovation */}
            <div className='card-services'>
              <img alt='' src='images/services/renovation.png'></img>
              <div className='flex flex-col gap-y-8 justify-around'>
                <div>
            ...
            <div className='card-services'>
              ...
              <img alt='' src='images/services/zinguerie.webp'></img>
            </div>
          </div>
        </div>
        ...
        <div id='contactus' className='container mx-auto flex flex-col items-center gap-y-10'>
          ...
          <motion.form variants={upward} initial="variantInit" whileInView="variantAnim" viewport={{once: true}} transition={transition1_s} onSubmit={handleSubmit} className="w-80 lg:w-full lg:max-w-lg mx-auto flex flex-col items-center">
